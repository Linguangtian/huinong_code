...
<head>
    ...
    <style type="text/css">
        .icon-setup1{background: url(/addons/zjhj_mall/core/web/uploads/icon/icon-setup.png) ;} .active .icon-setup1{background: url(/addons/zjhj_mall/core/web/uploads/icon/icon-setup-ac.png); }
        .icon-xiaochengxus{background: url(/addons/zjhj_mall/core/web/uploads/icon/icon-xiaochengxus.png) ;} .active .icon-xiaochengxus{background: url(/addons/zjhj_mall/core/web/uploads/icon/icon-xiaochengxus-ac.png); }
        .icon-services{background: url(/addons/zjhj_mall/core/web/uploads/icon/icon-services.png) ;} .active .icon-services{background: url(/addons/zjhj_mall/core/web/uploads/icon/icon-services-ac.png); }
        .icon-activitys{background: url(/addons/zjhj_mall/core/web/uploads/icon/icon-activitys.png) ;} .active .icon-activitys{background: url(/addons/zjhj_mall/core/web/uploads/icon/icon-activitys-ac.png); }
        .icon-peoples{background: url(/addons/zjhj_mall/core/web/uploads/icon/icon-peoples.png) ;} .active .icon-peoples{background: url(/addons/zjhj_mall/core/web/uploads/icon/icon-peoples-ac.png); }
        .icon-jiegous{background: url(/addons/zjhj_mall/core/web/uploads/icon/icon-jiegous.png) ;} .active .icon-jiegous{background: url(/addons/zjhj_mall/core/web/uploads/icon/icon-jiegous-ac.png); }
        .icon-barrages{background: url(/addons/zjhj_mall/core/web/uploads/icon/icon-barrages.png) ;} .active .icon-barrages{background: url(/addons/zjhj_mall/core/web/uploads/icon/icon-barrages-ac.png); }
        .icon-couponss{background: url(/addons/zjhj_mall/core/web/uploads/icon/icon-couponss.png) ;} .active .icon-couponss{background: url(/addons/zjhj_mall/core/web/uploads/icon/icon-couponss-ac.png); }
        .icon-pintu-ms{background: url(/addons/zjhj_mall/core/web/uploads/icon/icon-pintu-ms.png) ;} .active .icon-pintu-ms{background: url(/addons/zjhj_mall/core/web/uploads/icon/icon-pintu-ms-ac.png); }
        .icon-iconxuexis{background: url(/addons/zjhj_mall/core/web/uploads/icon/icon-iconxuexis.png) ;} .active .icon-iconxuexis{background: url(/addons/zjhj_mall/core/web/uploads/icon/icon-iconxuexis-ac.png); }
...
<div class="sidebar <?= $current_menu && count($current_menu['children']) ? 'sidebar-sub' : null ?>">
    <div class="sidebar-1"  style="background: #FFFFFF; color:#444; ">
        <div class="logo" style="padding: 10px 0;">
            <a class="home-link"  style="background: #FFFFFF;"
               href="<?= $urlManager->createUrl(['mch/default/index']) ?>"> <?= $this->context->store->name ?> </a>
       <!--     <a class="home-link"  style="background: #FFFFFF;"
               href="<?/*= $urlManager->createUrl(['mch/default/index']) */?>"> <img src="/addons/zjhj_mall/core/web/uploads/index_logo.png" width="110px;"/> </a>-->
        </div>
        <div>
    ...
    <?php if ($current_menu && count($current_menu['children'])): ?>
        <div class="sidebar-2" STYLE="border-right:0 solid #eee;">
           <!-- <div class="current-menu-name"><?/*= $current_menu['name'] */?></div>-->
            <div class="current-menu-name"> </div>
            <div class="sidebar-content"  style="background: #F2F6F9;color: #485A6A;">
                    ...
                    <?php if (isset($item['children']) && is_array($item['children']) && count($item['children']) > 0): ?>
                        ...
                        <div class="sub-item-list">
                            <?php foreach ($item['children'] as $sub_item): ?>
                                <a class="nav-item det_bg <?= activeMenu($sub_item, $route) ?>"
...
<div class="main">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <?php if (Yii::$app->user->isGuest == false): ?>
                        <a class="dropdown-item"
                           href="https://www.ipatr.cn/index.php?c=user&amp;a=logout&amp;">退出登录</a>
                    <?php else: ?>
                        <a class="dropdown-item"
                          href="./index.php?c=user&a=logout">退出登录</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <div class="main-body" style="background: rgb(242, 246, 249);">
        <?= $content ?>
    </div>
</div>
