...
class Order extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['address_data','parents_order_code', 'content', 'offline_qrcode', 'integral', 'words', 'seller_comments'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'user_id' => '用户id',
            'order_no' => '订单号',
			'parents_order_code' => '订单号2',
            'is_receive_xiaofeigu' => '是否发放消费股',
